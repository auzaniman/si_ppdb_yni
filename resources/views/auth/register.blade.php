  ...
  >
    ...
    >
      <div class="right mx-lg-0 mx-auto">
        ...
        <h3 class="title-text">Daftar untuk menjadi bagian dari kami</h3>
        ...
        <form style="margin-top: 1.5rem" action="{{ route('register') }}" method="post">
          ...
          <div style="margin-top: 1rem">
            <label for="email" class="d-block input-label">{{ __('E-Mail Address') }}</label>
            <div class="d-flex w-100 div-input">
              <svg
                class="icon"
                style="margin-right: 1rem"
        ...
        <p class="text-center bottom-caption">
          Sudah memilik akun?
          <a href="{{ route('login') }}" class="green-bottom-caption">Masuk disini</a>
        </p>
      </div>
    </div>
  </div>
