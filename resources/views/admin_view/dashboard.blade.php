...
<html lang="en">
  <head>
    ...
    @include('admin_view.components.style')
  ...
  <body id="page-top">
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="tables.html">Data Pendaftar</a>
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; Real-Engineer1453</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
    ...
    @include('admin_view.components.script')
  </body>
</html>
